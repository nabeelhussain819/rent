    ...
    (s = function (e) {
        ...
        (s = function () {
                            ...
                            return (
                                ...
                                void 0 === (a = l[r])
                                    ...
                                    ? i[n].get
                                        ...
                                        : i[n][a] || a
                                    : (p(a) &&
                                          (a = e.get("numberFormatter")
                                              ? e.get("numberFormatter")(a)
                                              : f(
                                                    a,
                                                    o,
                                                    e.get(
            ...
            (f = function (t, i, s, r, n) {
                ...
                for (
                    t = (
                        !1 === i ? parseFloat(t).toString() : t.toFixed(i)
                    ).split(""),
                        (a = (a = e.inArray(".", t)) < 0 ? t.length : a) <
                            t.length && (t[a] = n),
                        o = a - s;
                    o > 0;
                    o -= s
            ...
            (e.fn.simpledraw = function (i, s, r, n) {
                ...
                if (void 0 === e.fn.sparkline.canvas) {
                    ...
                    if (h.getContext && h.getContext("2d"))
                        e.fn.sparkline.canvas = function (t, i, e, s) {
                            return new W(t, i, e, s);
                        };
                    else {
                        if (!t.namespaces || t.namespaces.v)
                            return (e.fn.sparkline.canvas = !1), !1;
                        t.namespaces.add(
                            "v",
                ...
                return (
                    void 0 === i && (i = e(this).innerWidth()),
                    void 0 === s && (s = e(this).innerHeight()),
                    (a = e.fn.sparkline.canvas(i, s, this, n)),
            ...
            (m = r({
                ...
                registerCanvas: function (t) {
                    ...
                    (this.canvas = t),
                        (this.$canvas = i),
                        i.mouseenter(e.proxy(this.mouseenter, this)),
                        i.mouseleave(e.proxy(this.mouseleave, this)),
                        i.click(e.proxy(this.mouseclick, this));
                },
                reset: function (t) {
                    (this.splist = []),
                        this.tooltip &&
                ...
                mouseenter: function (i) {
                    e(t.body).unbind("mousemove.jqs"),
                        ...
                        !this.tooltip &&
                            ...
                            ((this.tooltip = new x(this.options)),
            ...
            (x = r({
                ...
                init: function (i) {
                    var s,
                        r = i.get("tooltipClassname", "jqstooltip"),
                        n = this.sizeStyle;
                ...
                updateWindowDims: function () {
                    (this.scrollTop = e(window).scrollTop()),
                        ...
                        (this.scrollRight =
                            this.scrollLeft + e(window).width()),
                        this.updatePosition();
                },
                getSize: function (t) {
            ...
            (q = []),
            (e.fn.sparkline = function (i, s) {
                return this.each(function () {
                    var r,
                        n,
                        a = new e.fn.sparkline.options(this, s),
                        o = e(this);
                    if (
                        ((r = function () {
                            var s, r, n, h, l, g, p;
                            "html" === i || void 0 === i
                                ...
                                (r =
                                    "auto" === a.get("width")
                                        ? s.length *
                                          a.get("defaultPixelsPerValue")
                                        : a.get("width")),
                                "auto" === a.get("height")
                                    ? (a.get("composite") &&
                                          e.data(this, "_jqs_vcanvas")) ||
                                      (((h =
                                          t.createElement("span")).innerHTML =
                                          "a"),
                                      o.html(h),
                                      (n = e(h).innerHeight() || e(h).height()),
                                      e(h).remove(),
                                      (h = null))
                                    : (n = a.get("height")),
                                a.get("disableInteraction")
                                    ? (l = !1)
                                    : (l = e.data(this, "_jqs_mhandler"))
                                    ? a.get("composite") || l.reset()
                                    : ((l = new m(this, a)),
                                      e.data(this, "_jqs_mhandler", l)),
                                !a.get("composite") ||
                                e.data(this, "_jqs_vcanvas")
                                    ? ((g = new e.fn.sparkline[a.get("type")](
                                          this,
                                          s,
                                          a,
                                          r,
                        ...
                        if (!a.get("composite") && e.data(this, "_jqs_pending"))
                            for (n = q.length; n; n--)
                                q[n - 1][0] == this && q.splice(n - 1, 1);
                ...
                for (i = 0, s = q.length; i < s; i++)
                    (t = q[i][0]),
                        e(t).is(":visible") && !e(t).parents().is(":hidden")
                            ? (q[i][1].call(t),
                              e.data(q[i][0], "_jqs_pending", !1),
                              r.push(i))
                            : e(t).closest("html").length ||
                              e.data(t, "_jqs_pending") ||
                              (e.data(q[i][0], "_jqs_pending", !1), r.push(i));
                for (i = r.length; i; i--) q.splice(r[i - 1], 1);
            }),
            (e.fn.sparkline.options = r({
                init: function (t, i) {
                    ...
                    (this.userOptions = i = i || {}),
                        (this.tag = t),
                        (this.tagValCache = {}),
                        (n = (r = e.fn.sparkline.defaults).common),
                        (this.tagOptionsPrefix =
                            i.enableTagOptions &&
                            (i.tagOptionsPrefix || n.tagOptionsPrefix)),
                        (s =
                            (a = this.getTagSetting("type")) === I
                                ? r[i.type || n.type]
                                : r[a]),
                        (this.mergedOptions = e.extend({}, n, s, i));
                },
            ...
            (e.fn.sparkline._base = r({
                ...
                setRegionHighlight: function (t, i, e) {
                    ...
                    return i > this.canvasWidth ||
                        ...
                        e < 0
                        ? null
                        : r !== (s = this.getRegion(t, i, e)) &&
                              (void 0 !== r && n && this.removeHighlight(),
                              (this.currentRegion = s),
                              void 0 !== s && n && this.renderHighlight(),
                              !0);
                },
                ...
                getCurrentRegionTooltip: function () {
                    ...
                    if (
                        ...
                        for (g = [], o = t.length; o--; )
                            (p = t[o][l]),
                                -1 != (f = e.inArray(p, h)) && (g[f] = t[o]);
                        t = g;
                    }
                    for (s = i.length, c = t.length, o = 0; o < s; o++)
                        for (
                            "string" == typeof (u = i[o]) && (u = new n(u)),
                                r = u.fclass || "jqsfield",
                                f = 0;
                            f < c;
                            f++
                        )
                            (t[f].isNull && v.get("tooltipSkipNull")) ||
                                (e.extend(t[f], {
                ...
                calcHighlightColor: function (t, e) {
                    ...
                    if (
                        ...
                        for (
                            n = [], r = 4 === t.length ? 16 : 1, o = 0;
                            o < 3;
                            o++
                        )
                            n[o] = a(
                                i.round(parseInt(s[o + 1], 16) * r * l),
                                0,
                                255
                            );
                        return "rgb(" + n.join(",") + ")";
            ...
            (y = {
                changeHighlight: function (t) {
                    var i,
                        ...
                        r = this.target,
                        n = this.regionShapes[s];
                    n &&
                        ((i = this.renderRegion(s, t)),
                        e.isArray(i) || e.isArray(n)
                            ? (r.replaceWithShapes(n, i),
                              (this.regionShapes[s] = e.map(i, function (t) {
                                  return t.id;
                              })))
                            : (r.replaceWithShape(n, i),
                              (this.regionShapes[s] = i.id)));
                },
                render: function () {
                    var t,
                        i,
                    ...
                    if (this.cls._super.render.call(this)) {
                        for (s = n.length; s--; )
                            if ((t = this.renderRegion(s)))
                                if (e.isArray(t)) {
                                    for (i = [], r = t.length; r--; )
                                        t[r].append(), i.push(t[r].id);
                                    o[s] = i;
                                } else t.append(), (o[s] = t.id);
                            else o[s] = null;
                        a.render();
                    }
                },
            }),
            (e.fn.sparkline.line = C =
                r(e.fn.sparkline._base, {
                    type: "line",
                    init: function (t, i, e, s, r) {
                        C._super.init.call(this, t, i, e, s, r),
                            (this.vertices = []),
                            (this.regionMap = []),
                            (this.xvalues = []),
                            (this.yvalues = []),
                    ...
                    renderHighlight: function () {
                        var t,
                            ...
                            h = n.get("highlightLineColor");
                        r &&
                            (a &&
                                o &&
                                ((t = s.drawCircle(r[0], r[1], a, void 0, o)),
                            ...
                            h &&
                                ...
                                s.insertAfterShape(this.lastShapeId, i)));
                    },
                    removeHighlight: function () {
                        var t = this.target;
                    ...
                    scanValues: function () {
                            ...
                            (e = a[t]),
                                ...
                                s && 2 === n.length
                                    ? (h.push(Number(n[0])),
                                      ...
                                      g.push(Number(n[1])))
                                    : r
                                    ? (h.push(e[0]), l.push(e[1]), g.push(e[1]))
                                    : (h.push(t),
                                      null === a[t] || "null" === a[t]
                                          ? l.push(null)
                                          : (l.push(Number(e)),
                        ...
                        this.options.get("xvalues") &&
                            (h = this.options.get("xvalues")),
                            (this.maxy = this.maxyorg = i.max.apply(i, g)),
                            (this.miny = this.minyorg = i.min.apply(i, g)),
                            (this.maxx = i.max.apply(i, h)),
                            (this.minx = i.min.apply(i, h)),
                            (this.xvalues = h),
                            (this.yvalues = l),
                            (this.yminmax = g);
                    },
                    ...
                    render: function () {
                        ...
                        if (
                                ...
                                n = a = 0,
                                    ...
                                    j &&
                                        ...
                                        (R ||
                                            ...
                                            (T -= i.ceil(j))),
                                    q--,
                                    void 0 === H.get("normalRangeMin") ||
                                        H.get("drawNormalOnTop") ||
                                        this.drawNormalRange(a, n, q, T, s),
                                    l = [(h = [])],
                                    c = f = null,
                                    m = M.length,
                                    _ = 0;
                                    ...
                                    null === p
                                        ? _ &&
                                          (null !== M[_ - 1] &&
                                              ((h = []), l.push(h)),
                                          I.push(null))
                                        : (p < this.miny && (p = this.miny),
                                          p > this.maxy && (p = this.maxy),
                                          h.length || h.push([u, n + q]),
                                          (o = [
                                              u,
                                              n +
                                                  i.round(
                            ...
                            for (
                                ...
                                (h = l[_]).length &&
                                    (H.get("fillColor") &&
                                        (h.push([h[h.length - 1][0], n + q]),
                                        y.push(h.slice(0)),
                                        h.pop()),
                                    h.length > 2 && (h[0] = [h[0][0], h[1][1]]),
                                    x.push(h));
                            for (w = y.length, _ = 0; _ < w; _++)
                                W.drawShape(
                                    y[_],
                                    H.get("fillColor"),
                                    H.get("fillColor")
                            ...
                            if (j && H.get("valueSpots"))
                                for (
                                    void 0 === (b = H.get("valueSpots")).get &&
                                        (b = new v(b)),
                                        _ = 0;
                                    _ < m;
                                    _++
            ...
            (e.fn.sparkline.bar = w =
                r(e.fn.sparkline._base, y, {
                    type: "bar",
                    init: function (t, s, r, n, o) {
                        var p,
                            ...
                            V = -1 / 0;
                        for (
                            w._super.init.call(this, t, s, r, n, o),
                                m = 0,
                                x = s.length;
                            m < x;
                            m++
                            ...
                            ((p =
                                ...
                                p && (I = s[m] = l(I.split(":"))),
                                (I = g(I, null)),
                                (d = i.min.apply(i, I)) < O && (O = d),
                                (u = i.max.apply(i, I)) > V && (V = u));
                        (this.stacked = _),
                            (this.regionShapes = {}),
                            (this.barWidth = P),
                            (this.barSpacing = L),
                            (this.totalBarWidth = P + L),
                            (this.width = n =
                                s.length * P + (s.length - 1) * L),
                            this.initTarget(),
                            B &&
                                ((k = void 0 === A ? -1 / 0 : A),
                                (M = void 0 === F ? 1 / 0 : F)),
                        ...
                        for (m = 0, x = s.length; m < x; m++)
                            if (_)
                                ...
                                (I = B ? a(s[m], k, M) : s[m]),
                                    null !== (I = s[m] = h(I)) && f.push(I);
                        (this.max = S = i.max.apply(i, f)),
                            (this.min = R = i.min.apply(i, f)),
                            (this.stackMax = V = _ ? i.max.apply(i, X) : S),
                            (this.stackMin = O = _ ? i.min.apply(i, f) : R),
                            void 0 !== r.get("chartRangeMin") &&
                                (r.get("chartRangeClip") ||
                                    r.get("chartRangeMin") < R) &&
                                (R = r.get("chartRangeMin")),
                            void 0 !== r.get("chartRangeMax") &&
                                (r.get("chartRangeClip") ||
                                    r.get("chartRangeMax") > S) &&
                                (S = r.get("chartRangeMax")),
                            ...
                            (this.xaxisOffset = b),
                            (y = _
                                ? i.max.apply(i, c) + i.max.apply(i, z)
                                : S - R),
                            (this.canvasHeightEf =
                                C && R < 0
                                    ? this.canvasHeight - 2
                            ...
                            R < b
                                ? (j =
                                      (((_ && S >= 0 ? V : S) - b) / y) *
                                      this.canvasHeight) !== i.ceil(j) &&
                                  ((this.canvasHeightEf -= 2), (j = i.ceil(j)))
                                : (j = this.canvasHeight),
                            (this.yoffset = j),
                            e.isArray(r.get("colorMap"))
                        ...
                        if (
                            ...
                            return v.get("nullColor")
                                ? ((a = s
                                  ...
                                  (r = S > 0 ? S - 1 : S),
                                  w.drawRect(b, r, this.barWidth - 1, 0, a, a))
                                : void 0;
                        for (h = S, l = 0; l < g; l++) {
                            if (((p = f[l]), C && p === m)) {
                                if (!c || u) continue;
                            ...
                            (n =
                                y > 0
                                    ? i.floor(R * (i.abs(p - m) / y)) + 1
                                    : 1),
                                p < m || (p === m && 0 === S)
                                    ? ((r = h), (h += n))
                                    : ((r = S - n), (S -= n)),
                                (a = this.calcColor(l, p, t)),
                                s && (a = this.calcHighlightColor(a, v)),
                                x.push(
                                    w.drawRect(
                                        b,
                                        r,
            ...
            (e.fn.sparkline.tristate = b =
                r(e.fn.sparkline._base, y, {
                    type: "tristate",
                    init: function (t, i, s, r, n) {
                        var a = parseInt(s.get("barWidth"), 10),
                            o = parseInt(s.get("barSpacing"), 10);
                        b._super.init.call(this, t, i, s, r, n),
                            (this.regionShapes = {}),
                            (this.barWidth = a),
                            (this.barSpacing = o),
                            (this.totalBarWidth = a + o),
                            (this.values = e.map(i, Number)),
                            (this.width = r =
                                i.length * a + (i.length - 1) * o),
                            e.isArray(s.get("colorMap"))
                    ...
                    renderRegion: function (t, e) {
                        ...
                        if (
                            ...
                            return (
                                e && (h = this.calcHighlightColor(h, g)),
                                p.drawRect(a, o, this.barWidth - 1, r - 1, h, h)
                            );
                    },
                })),
            (e.fn.sparkline.discrete = R =
                r(e.fn.sparkline._base, y, {
                    type: "discrete",
                    init: function (t, s, r, n, a) {
                        R._super.init.call(this, t, s, r, n, a),
                            (this.regionShapes = {}),
                            (this.values = s = e.map(s, Number)),
                            (this.min = i.min.apply(i, s)),
                            (this.max = i.max.apply(i, s)),
                            (this.range = this.max - this.min),
                            (this.width = n =
                                "auto" === r.get("width")
                                    ? 2 * s.length
                                    : this.width),
                            (this.interval = i.floor(n / s.length)),
                            (this.itemWidth = n / s.length),
                            void 0 !== r.get("chartRangeMin") &&
                                (r.get("chartRangeClip") ||
                    ...
                    renderRegion: function (t, e) {
                        ...
                        return (
                            ...
                            (n =
                                ...
                                r < l.get("thresholdValue")
                                    ? l.get("thresholdColor")
                                    : l.get("lineColor")),
                            e && (n = this.calcHighlightColor(n, l)),
                            c.drawLine(o, s, o, s + v, n)
                        );
                    },
                })),
            (e.fn.sparkline.bullet = S =
                r(e.fn.sparkline._base, {
                    type: "bullet",
                    init: function (t, e, s, r, n) {
                        var a, o, h;
                        S._super.init.call(this, t, e, s, r, n),
                            (this.values = e = l(e)),
                    ...
                    getRegion: function (t, i, e) {
                        ...
                        return void 0 !== s && void 0 !== this.shapes[s]
                            ? this.shapes[s]
                            : void 0;
                    },
                    getCurrentRegionFields: function () {
                    ...
                    renderRange: function (t, e) {
                        var s = this.values[t],
                            r = i.round(
                                this.canvasWidth * ((s - this.min) / this.range)
                            ),
                    ...
                    renderTarget: function (t) {
                        var e = this.values[0],
                            ...
                            r = i.round(0.1 * this.canvasHeight),
                        ...
                        for (a = c.length, n = 0; n < a; n++) {
                            if (
                                ...
                                return (
                                    ...
                                    h.drawPieSlice(g, g, g - p, s, r, void 0, o)
                                );
                            v = r;
                        }
                    },
            ...
            (e.fn.sparkline.box = M =
                r(e.fn.sparkline._base, {
                    type: "box",
                    init: function (t, i, s, r, n) {
                        M._super.init.call(this, t, i, s, r, n),
                            (this.values = e.map(i, Number)),
                            (this.width =
                                "auto" === s.get("width") ? "4.0em" : r),
                            this.initTarget(),
                    ...
                    render: function () {
                        var t,
                            ...
                            x = this.canvasHeight,
                            y =
                                void 0 === v.get("chartRangeMin")
                                    ? i.min.apply(i, c)
                                    : v.get("chartRangeMin"),
                            C =
                                void 0 === v.get("chartRangeMax")
                                    ? i.max.apply(i, c)
                                    : v.get("chartRangeMax"),
                            w = 0;
                        if (M._super.render.call(this)) {
                            if (v.get("raw"))
                                v.get("showOutliers") && c.length > 5
                                    ? ((e = c[0]),
                                      (t = c[1]),
                                      (r = c[2]),
                                      (n = c[3]),
                                ...
                                for (t = h = void 0, g = 0; g < f; g++)
                                    void 0 === t &&
                                        c[g] > r - s * v.get("outlierIQR") &&
                                        (t = c[g]),
                                        c[g] < a + s * v.get("outlierIQR") &&
                                            (h = c[g]);
                                (e = c[0]), (l = c[f - 1]);
                            } else (t = c[0]), (h = c[f - 1]);
                            (this.quartiles = [r, n, a]),
                                (this.lwhisker = t),
                                (this.rwhisker = h),
                                (this.loutlier = e),
                                (this.routlier = l),
                                (d = m / (C - y + 1)),
                                v.get("showOutliers") &&
                                    ((w = i.ceil(v.get("spotRadius"))),
                                    (d =
                                        (m -= 2 * i.ceil(v.get("spotRadius"))) /
                                        (C - y + 1)),
                                    e < t &&
                                        u
                                            .drawCircle(
            ...
            (H = r({
                ...
                _calculatePixelDims: function (t, i, s) {
                    var r;
                    (r = this._pxregex.exec(i)),
                        (this.pixelHeight = r ? r[1] : e(s).height()),
                        (r = this._pxregex.exec(t)),
                        (this.pixelWidth = r ? r[1] : e(s).width());
                },
                _genShape: function (t, i) {
                    var e = j++;
                    return i.unshift(e), new _(this, e, t, i);
                },
            ...
            (W = r(H, {
                init: function (i, s, r, n) {
                    W._super.init.call(this, i, s, r),
                        ...
                        this._calculatePixelDims(i, s, this.canvas),
                ...
                _getContext: function (t, i, e) {
                    ...
                    return (
                        void 0 !== t && (s.strokeStyle = t),
                        (s.lineWidth = void 0 === e ? 1 : e),
                        void 0 !== i && (s.fillStyle = i),
                        s
                    );
                },
                reset: function () {
                ...
                replaceWithShapes: function (t, i) {
                    ...
                    for (s = n.length; s--; )
                        a[(e = n[s])] &&
                            (n.splice(s, 1), delete this.shapes[e], (r = s));
                    for (s = i.length; s--; )
                        n.splice(r, 0, i[s].id), (this.shapes[i[s].id] = i[s]);
                },
                insertAfterShape: function (t, i) {
                    var e,
                        s = this.shapeseq;
                ...
                render: function () {
                    ...
                    for (
                        ...
                        this["_draw" + (t = s[e[i]]).type].apply(this, t.args);
            ...
            (T = r(H, {
                ...
                _drawPieSlice: function (t, e, s, r, n, a, o, h) {
                    ...
                    if (n === a) return "";
                    if (
                        (a - n == 2 * i.PI && ((n = 0), (a = 2 * i.PI)),
                        (g = e + i.round(i.cos(n) * r)),
                        (p = s + i.round(i.sin(n) * r)),
                        (d = e + i.round(i.cos(a) * r)),
                        (u = s + i.round(i.sin(a) * r)),
                        g === d && p === u)
                    ) {
                        if (a - n < i.PI) return "";
                        (g = d = e + r), (p = u = s);
                    }
                    return g === d && p === u && a - n < i.PI
                        ? ""
                        : ((l = [e - r, s - r, e + r, s + r, g, p, d, u]),
                          (c =
                              void 0 === o
                                  ? ' stroked="false" '
                ...
                replaceWithShapes: function (t, i) {
                    var s,
                        ...
                        a = i.length;
                    for (s = 0; s < a; s++)
                        n += this["_draw" + i[s].type].apply(this, i[s].args);
                    for (r[0].outerHTML = n, s = 1; s < t.length; s++)
                        e("#jqsshape" + t[s]).remove();
                },
                insertAfterShape: function (t, i) {
                    var s = e("#jqsshape" + t),
                        r = this["_draw" + i.type].apply(this, i.args);
